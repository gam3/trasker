...
const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE "tlist";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -s, --setup        Run setup on startup  (default=off)",
  "      --show=STRING  Open widow on startup  (possible values=\"project\", \n                       \"timeedit\", \"_none_\" default=`_none_')",
  "\n",
    0
};
...
char *cmdline_parser_show_values[] = {"project", "timeedit", "_none_", 0} ;	/* Possible values for show.  */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->setup_help = gengetopt_args_info_help[2] ;
  args_info->show_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->show_given, "show", args_info->show_orig, cmdline_parser_show_values);
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* Open widow on startup.  */
          if (strcmp (long_options[option_index].name, "show") == 0)
          {

            if (update_multiple_arg_temp(&show_list,
                &(local_args_info.show_given), optarg, cmdline_parser_show_values, "_none_", ARG_STRING,
                "show", '-',
                additional_error))
              goto failure;
  ...
  multiple_default_value.string_arg = "_none_";
  update_multiple_arg((void *)&(args_info->show_arg),
    &(args_info->show_orig), args_info->show_given,
    local_args_info.show_given, &multiple_default_value ,
